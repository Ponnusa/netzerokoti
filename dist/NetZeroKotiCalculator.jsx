...
const FinnishCO2Calculator = () => {
  ...
  const getDietEmissionFactor = (dietType) => {
    const dietFactors = {
      'meat-heavy': 1.4,      // 1.2-1.6 range, using middle
      'balanced': 0.85,       // 0.7-1.0 range, using middle-high
      'vegetarian': 0.6,      // 0.5-0.7 range, using middle
      'vegan': 0.4,          // 0.3-0.5 range, using middle
      'national': 0.7        // 0.6-0.8 range, using middle
    };
  ...
  const calculateEmissions = () => {
    ...
    if (formData.hotWaterReading || formData.coldWaterReading) {
      ...
      const periodMultiplier = formData.waterPeriod === 'monthly' ? 12 : 
                              formData.waterPeriod === 'quarterly' ? 4 :
                              formData.waterPeriod === 'semi-annual' ? 2 : 1;
    ...
    const electricityFactor = electricityEmissionFactors[formData.electricityProvider]?.[formData.productType] || 234;
    const yearlyElectricityConsumption = formData.consumptionPeriod === 'monthly' ? 
      formData.electricityConsumption * 12 : formData.electricityConsumption;
    ...
    if (formData.groceryMethod === 'loyalty' && formData.groceryCO2) {
      ...
      const factor = formData.emissionFactor && formData.emissionFactor !== '' ? 
        parseFloat(formData.emissionFactor) : getDietEmissionFactor(formData.dietType);
    ...
    return (
      <div className="relative w-48 h-48 mx-auto">
        <svg className="w-full h-full transform -rotate-90" viewBox="0 0 200 200">
          <circle cx="100" cy="100" r={radius} stroke="#e5e7eb" strokeWidth="12" fill="none" />
          <circle
            cx="100" cy="100" r={radius} stroke={getScoreColor(score)} strokeWidth="12"
            fill="none" strokeLinecap="round" strokeDasharray={strokeDasharray}
      ...
      <div className="bg-blue-100 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg">
        <div className="flex items-start">
          ...
          <div className="text-sm text-blue-800">
            ...
            <div className="mb-2">
              This calculator is the property of <strong>NetZeroKoti, Finland</strong>. 
              It is provided for educational purposes only and may not be copied, reproduced, 
              or distributed without proper permissions from NetZeroKoti.
            </div>
            <div className="text-xs">
              For permissions and inquiries, contact us at: 
              <a href="mailto:netzerokoti@gmail.com" className="font-medium underline ml-1">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Calculate your carbon footprint from heating, electricity, transport, and groceries
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="number" min="10" max="1000" value={formData.builtArea}
                    onChange={(e) => handleInputChange('builtArea', parseInt(e.target.value) || 0)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="number" min="1900" max="2025" value={formData.constructionYear}
                    onChange={(e) => handleInputChange('constructionYear', parseInt(e.target.value) || 2000)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="number" min="1" max="10" value={formData.residents}
                    onChange={(e) => handleInputChange('residents', parseInt(e.target.value) || 1)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                {formData.heatingSystem === 'district' && (
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => handleInputChange('districtLocation', e.target.value)}
                      className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                    >
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Hot Water (m³)</label>
                  <input
                    type="number" step="0.1" value={formData.hotWaterReading}
                    onChange={(e) => handleInputChange('hotWaterReading', e.target.value)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Cold Water (m³)</label>
                  <input
                    type="number" step="0.1" value={formData.coldWaterReading}
                    onChange={(e) => handleInputChange('coldWaterReading', e.target.value)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                    placeholder="Optional"
                  />
                </div>
                ...
                <div className="col-span-2">
                  ...
                  <select
                    ...
                    onChange={(e) => handleInputChange('waterPeriod', e.target.value)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  >
            ...
            <div className="bg-yellow-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="number" value={formData.electricityConsumption}
                    onChange={(e) => handleInputChange('electricityConsumption', parseInt(e.target.value) || 0)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleInputChange('consumptionPeriod', e.target.value)}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                  >
                    <option value="monthly">Monthly</option>
            ...
            <div className="bg-green-50 p-6 rounded-lg">
              ...
              <div className="space-y-4">
                {formData.vehicles.map((vehicle) => (
                  <div key={vehicle.id} className="bg-white p-4 rounded-lg border">
                    <div className="flex justify-between items-center mb-3">
                      <input
                        type="text" value={vehicle.name}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="block text-xs font-medium text-gray-700 mb-1">Fuel/Size</label>
                        <select
                      ...
                      <div>
                        ...
                        <input
                          type="number" value={vehicle.kilometers}
                          onChange={(e) => updateVehicle(vehicle.id, 'kilometers', parseInt(e.target.value) || 0)}
                          className="w-full p-2 text-sm border border-gray-300 rounded-md"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => updateVehicle(vehicle.id, 'period', e.target.value)}
                          className="w-full p-2 text-sm border border-gray-300 rounded-md"
                        >
                          <option value="monthly">Monthly</option>
                          <option value="yearly">Yearly</option>
                      ...
                      <div className="col-span-2">
                        <label className="block text-xs font-medium text-gray-700 mb-1">Custom CO₂ (g/km)</label>
                        <input
                          type="number" step="0.1" value={vehicle.customEmissions}
                          onChange={(e) => updateVehicle(vehicle.id, 'customEmissions', e.target.value)}
                          className="w-full p-2 text-sm border border-gray-300 rounded-md"
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-3">
                  <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-white">
                    <input
                      type="radio" name="groceryMethod" value="loyalty"
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600">K-Plussa, S-Bonus CO₂ data</div>
                    </div>
                  </label>
                  
                  <label className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-white">
                    <input
                      type="radio" name="groceryMethod" value="spending"
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600">Calculate from spending amount</div>
                    </div>
                  </label>
                </div>
                ...
                {formData.groceryMethod === 'loyalty' && (
                  <div className="bg-white p-4 rounded-lg border">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">CO₂ (kg)</label>
                        <input
                          type="number" step="0.1" value={formData.groceryCO2}
                  ...
                  <div className="bg-white p-4 rounded-lg border">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="number" step="0.01" value={formData.grocerySpend}
                      ...
                      <div className="col-span-2">
                        ...
                        <div className="text-xs text-gray-500 mt-1">
                          {formData.dietType === 'meat-heavy' && 'High red meat intake, processed foods; above national avg'}
                          {formData.dietType === 'balanced' && 'Typical Finnish diet: mix of meat, dairy, grains, vegetables'}
                          {formData.dietType === 'vegetarian' && 'Limited meat and dairy; more legumes, grains, vegetables'}
                          {formData.dietType === 'vegan' && 'No animal products; low-impact foods dominate'}
                          {formData.dietType === 'national' && 'Weighted average of typical consumer (per Luke & K-Ostokset)'}
                        </div>
                      </div>
                      ...
                      <div className="col-span-2">
                        ...
                        <input
                          type="number" step="0.1" value={formData.emissionFactor}
                        ...
                        />
                        <div className="text-xs text-gray-500 mt-1">
                          Leave empty to use diet type default, or enter custom value
                        </div>
                      </div>
                    </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-red-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-red-600">
                    {results.totalEmissions.toFixed(0)} kg CO₂{formData.displayMode === 'monthly' ? '/month' : '/year'}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-orange-50 p-3 rounded text-center">
                    <div className="font-semibold text-orange-600">{results.heatingEmissions.toFixed(0)} kg</div>
                    <div className="text-gray-600">Heating</div>
                  </div>
                  <div className="bg-yellow-50 p-3 rounded text-center">
                    <div className="font-semibold text-yellow-600">{results.electricityEmissions.toFixed(0)} kg</div>
                    <div className="text-gray-600">Electricity</div>
                  </div>
                  <div className="bg-green-50 p-3 rounded text-center">
                    <div className="font-semibold text-green-600">{results.transportEmissions.toFixed(0)} kg</div>
                    <div className="text-gray-600">Transport</div>
                  </div>
                  <div className="bg-purple-50 p-3 rounded text-center">
                    <div className="font-semibold text-purple-600">{results.groceryEmissions.toFixed(0)} kg</div>
                    <div className="text-gray-600">Groceries</div>
                  </div>
                  <div className="bg-blue-50 p-3 rounded text-center col-span-2">
                    <div className="font-semibold text-blue-600">{results.wastewaterEmissions.toFixed(0)} kg</div>
                ...
                <div className="border-t pt-4">
                  <div className="grid grid-cols-3 gap-4 text-sm text-center">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-blue-600">{results.emissionRating}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Per Person</div>
                      <div className="text-lg">{results.perPersonEmissions.toFixed(0)} kg</div>
                    </div>
                    <div>
                      <div className="font-semibold">Per m²</div>
                      <div className="text-lg">{results.perM2Emissions.toFixed(1)} kg</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">vs Finnish Average</h3>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span>Your emissions:</span>
                  <span className="font-semibold">
                    {(formData.displayMode === 'monthly' ? results.totalEmissions * 12 : results.totalEmissions).toFixed(0)} kg/year
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between pt-2 border-t">
                  ...
                  <span className={`font-bold ${
                    (formData.displayMode === 'monthly' ? results.totalEmissions * 12 : results.totalEmissions) < 4200 
                      ? 'text-green-600' : 'text-red-600'
                  }`}>
                    {((formData.displayMode === 'monthly' ? results.totalEmissions * 12 : results.totalEmissions) - 4200).toFixed(0)} kg/year
                  </span>
                </div>
              </div>
            </div>
            ...
            {showComparison && (
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Improvement Scenarios</h3>
                <div className="space-y-3">
                  <div className="bg-gray-50 p-3 rounded">
                    <div className="font-semibold text-gray-800">Renewable Electricity</div>
                    <div className="text-green-600">Save: -{results.electricityEmissions.toFixed(0)} kg CO₂/year</div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded">
                    <div className="font-semibold text-gray-800">Electric Vehicles</div>
                    <div className="text-green-600">Save: -{results.transportEmissions.toFixed(0)} kg CO₂/year</div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded">
                    <div className="font-semibold text-gray-800">Reduce Meat 30%</div>
                    <div className="text-green-600">Save: -{(results.groceryEmissions * 0.3).toFixed(0)} kg CO₂/year</div>
                  </div>
                  <div className="bg-gray-50 p-3 rounded">
                    <div className="font-semibold text-gray-800">Energy Renovation</div>
                    <div className="text-green-600">Save: -{(results.heatingEmissions * 0.4).toFixed(0)} kg CO₂/year</div>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="text-sm text-gray-700 space-y-2">
                <p><strong>Heating:</strong> Based on building age and area. Newer buildings are more efficient.</p>
                <p><strong>Electricity:</strong> Varies by provider. Renewable options have zero emissions.</p>
                <p><strong>Transport:</strong> Calculated from vehicles and usage. Electric vehicles are cleanest.</p>
                <p><strong>Groceries:</strong> From loyalty card data or spending × emission factor.</p>
                <p><strong>Score:</strong> 100 = zero emissions, 60 = Finnish average, 1 = very high.</p>
              </div>
            </div>
          </div>
        </div>
...
export default FinnishCO2Calculator;
